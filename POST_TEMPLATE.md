...
I’m excited to share a new project I built: an automated cloud governance engine for AWS that combines FinOps, DevSecOps, and cloud automation into one practical, event-driven workflow.

What it does:
- Enforces required tagging for EC2 resources
- Identifies expired infrastructure using TTL-based cleanup logic
